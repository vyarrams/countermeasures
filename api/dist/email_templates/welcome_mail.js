...
exports.WelcomeEmail = exports.welcome_html = void 0;
exports.welcome_html = `<strong>Have fun!</strong>`;
class WelcomeEmail {
    getWelcomeMailTemplate(name, token, email) {
...
body {font-family: 'Muli', sans-serif;}
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 18px">Welcome to cofinds.com! Please verify your email address and join the fastest growing remote jobs platform!</span></div>
