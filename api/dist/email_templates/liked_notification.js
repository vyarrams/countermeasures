...
exports.LikedTemplate = void 0;
class LikedTemplate {
    getTemplate(user_name, user_img, url) {
        return `
...
body {font-family: 'Muli', sans-serif;}
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="padding:30px 30px 0px 30px; line-height:30px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 43px">${user_name} liked your post!</span></div>
<div style="font-family: inherit; text-align: center"><br></div><div></div></div></td>
    ...
    <tbody>
      <tr>
        <td style="padding:10px 30px 18px 30px; line-height:10px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 24px">Your're getting popular</span></div><div></div></div></td>
      </tr>
    </tbody>
...
exports.LikedTemplate = LikedTemplate;
